...
typedef int (*lp503x_func)(char *pargs);

/****************************************************************************
 * Private Function Prototypes
 ****************************************************************************/

static int lp503x_cmd_quit(char *parg);
static int lp503x_cmd_help(char *parg);
static int lp503x_cmd_set_rgbled(char *parg);
static int lp503x_cmd_setled(char *parg);
static int lp503x_cmd_setcolour(char *parg);
static int lp503x_cmd_pattern(char *parg);
static int lp503x_cmd_brightness(char *parg);
static int lp503x_cmd_mode(char *parg);
static int lp503x_cmd_disable(char *parg);
static int lp503x_cmd_set_bank_mode(char *parg);
static int lp503x_cmd_set_banka_colour(char *parg);
static int lp503x_cmd_set_bankb_colour(char *parg);
static int lp503x_cmd_set_bankc_colour(char *parg);
static int lp503x_cmd_set_bank_brightness(char *parg);
static int lp503x_cmd_set_individual_mode(char *parg);
